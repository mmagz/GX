...
const allowedOrigins = (process.env.CORS_ORIGINS || 'http://localhost:3000,http://localhost:5173,https://gx-admin-n49r.onrender.com,https://getxoned-frontend.onrender.com,https://gx-admin-n49r.onrender.com,https://getxoned-admin.onrender.com,https://www.getxoned.com,https://admin.naturesoap.in').split(',')
app.use(cors({
    origin: (origin, cb) => {
