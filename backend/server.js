...
const allowedOrigins = (process.env.CORS_ORIGINS || 'http://localhost:3000,http://localhost:5173,https://getxoned-frontend.onrender.com,https://getxoned-admin.onrender.com').split(',')
app.use(cors({
    origin: (origin, cb) => {
